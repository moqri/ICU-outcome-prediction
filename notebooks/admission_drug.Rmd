...
df_group=patient_admission %>% subset(!is.na(admissiondrugid)) %>% group_by(hospitalid) %>% tally(name = "patients")

hospitals= patient_group %>% full_join(gf_group)
